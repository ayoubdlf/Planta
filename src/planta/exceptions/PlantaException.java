...
public class PlantaException {
    ...
    public static void alert(String titre, String message) {
        ...
        alert.setTitle("Planta");

        DialogPane dialogPane = alert.getDialogPane();
        dialogPane.getStylesheets().add(Objects.requireNonNull(PlantaException.class.getResource("/css/styles.css")).toExternalForm());
    ...
    private static SVGPath getIcone() {
        ...
        svg.setStyle("-fx-stroke: red; -fx-stroke-width: 1.5; -fx-fill: transparent; -fx-stroke-line-cap: round; -fx-stroke-line-join: round ");
